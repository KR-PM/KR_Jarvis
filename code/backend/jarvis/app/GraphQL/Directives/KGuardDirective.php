 ...
 */
class KGuardDirective extends BaseDirective implements FieldMiddleware, TypeManipulator, TypeExtensionManipulator
{
...
GRAPHQL;
    ...
    {
        GraphQLKit::throwError(KCode::get(StatusCode::UNAUTHENTICATED));
    }
